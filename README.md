# 💗 PlymouthCat-Pink
*A soft pink animated Plymouth boot splash theme.*
...
### ## Optional: Test Plymouth Without Rebooting
...
PlymouthCat-PPink/
├── PlymouthCat-Pink.plymouth
├── PlymouthCat-Pink.script
├── progress-0.png
├── progress-1.png
├── ...
└── progress-110.png
...
Original animation: Plymouth Theme Cat  
Pink recolor + fork: **Morgan Voisin**

---

### ## Notes

Feel free to fork, modify, recolor, or remix.  
Plymouth themes are simple and fun to customize 💗
